<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
    {
      ...
      if($pass==$cpass){
          ...
          if($rowcount==0){
              $sql= "INSERT INTO `companyRegistration` (`email`, `password`,`nameOfCompany`,`category`,`type`,`dateTime`) VALUES ('$email', '$hash','$nameOfCompany','$category','company',current_timestamp())";
              $result=mysqli_query($conn,$sql);
              if($result){
                  $showAlert="Successfully Registered an account";
              }
              else{
  ...
  <div class="wrapper fadeInDown">
    ...
    <div class="text-center">
      <h2>
        ...
        <form method="post">
      <input type="text" id="nameOfCompany" class="fadeIn second" name="nameOfCompany" placeholder="Company Name">
